                        ...
                        <tbody>
                            ...
                            @foreach ($congvan as $value)
                                <tr class="odd gradeX" align="center">
                                    ...
                                    <td>{{ $value->dispatch_type()->first()->name }}</td>

                                    <td>{{ $value->issuing_agency()->first()->name }}</td>
                                    <td>{{ $value->document_form()->first()->name }}</td>
                                    <td>{{ $value->field()->first()->name }}</td>
                                    <td>{{ $value->document_type()->first()->name }}</td>
